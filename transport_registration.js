...
(function(){
  ...
  function build(){
    ...
    title.innerHTML='<h2 style="margin-top:18px">Vehicles</h2><p class="muted">Add every vehicle you want to offer on LEOGO. Each vehicle will be reviewed separately by Admin.</p>';
    ...
    if(vehicleGrid&&vehicleGrid!==modeGrid)vehicleGrid.remove();
    if(oldType){const cell=oldType.closest('div');if(cell&&modeGrid?.contains(cell))cell.remove();}
  }
